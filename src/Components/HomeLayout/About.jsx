...
function About() {
  return (
    <div className="about">
      <img src="/question1.png" alt="" className="top-left-img" />
      <img src="/suspect 1.png" alt="" className="bottom-right-img" />
      ...
      <div className="content-second">
        <div className="left-content">
          ...
          <img src="/1600px_COLOURBOX7835621 1.png" alt="" />
        </div>
        <div className="right-content">
          <div className="top-side">
            <p>We seek to expand the surveillance network to all countries</p>
            <img src="/pngtree-vector-labyrinth-maze-game-illustration-image_1140401 1.png" alt="" />
          </div>
          <div className="bottom-side">
            <p>Our eyes are everywhere for your safety, so your safety is our mission</p>
            <img src="/WhatsApp Image 2023-10-25 at 6.03 1.png" alt="" />
          </div>
        </div>
      </div>
    </div>
